...
if __name__ == '__main__':
    ...
    create_nuscenes_infos('data/nuscenes/', 'track_mutr')#位置已经放好了

    # generate .pkl for test set
    create_nuscenes_infos('data/nuscenes/', 'track_mutr_test', version='v1.0-test')#没有!